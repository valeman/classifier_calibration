...
class PostProcessing:
    ...
    """
    def __init__(self,pp_name, pp, instatiator_fn, fit_fn, predict_prob_fn):
    ...
    def instantiate(self, meta_data:dict) -> None:
        ...
        self.pp = self.pp(**self.instatiator_fn(meta_data))
...
class Learner:
    ...
    """
    def __init__(self,learner_name, learner,instatiator_fn, fit_fn, predict_prob_fn,pre_trained=False):
    ...
    def instantiate(self, meta_data:dict) -> None:
        lg.info(f"Learner:{self.learner_name} instantiated with:\n{self.instatiator_fn(meta_data)}")
        self.learner = self.learner(**self.instatiator_fn(meta_data))
